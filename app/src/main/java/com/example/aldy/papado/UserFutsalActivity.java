...
public class UserFutsalActivity extends AppCompatActivity {
    ...
    public void user_pindahactivity (MenuItem menuItem){
        switch (menuItem.getItemId()) {
            case R.id.user_nav_favorit:
                Intent favorit = new Intent(UserFutsalActivity.this, UserFavoritActivity.class);
                startActivity(favorit);
                finish();
                break;
            case R.id.user_nav_pemesanan:
                Intent pemesanan = new Intent(UserFutsalActivity.this, UserPemesananActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(UserFutsalActivity.this,UserPemesananActivity.class);
